...
class SoundsControllerTest < ActionController::TestCase
  ...
  test "should create sound" do
    assert_difference('Sound.count') do
      post :create, sound: { duracion: @sound.duracion, formato: @sound.formato, type_sound_id: @sound.type_sound_id }
    end
  ...
  test "should update sound" do
    patch :update, id: @sound, sound: { duracion: @sound.duracion, formato: @sound.formato, type_sound_id: @sound.type_sound_id }
    assert_redirected_to sound_path(assigns(:sound))
  end
